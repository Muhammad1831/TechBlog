...
class SolidColors {
  ...
  static const Color drawerSplashColor = Color.fromARGB(255, 232, 212, 238);
  static const Color profileItemSplashColor = Color.fromARGB(255, 232, 212, 238);
  static const Color textTitle = Color.fromARGB(255, 0, 0, 0);
  static const Color menuIcon = Color.fromARGB(255, 0, 0, 0);
  ...
  static const Color drawerBackgrounColor = Color.fromARGB(255, 255, 255, 255);
...
class GradientColors {
  ...
  static const List<Color> posterCoverHomePageGradient = [
  ...
  static const List<Color> posterSingleArticleScreen = [
